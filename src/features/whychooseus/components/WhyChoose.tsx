...
import { FeatureCard, IconBox } from '@/components/ui/card-component'
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {whyChooseData.features.map((feature) => (
            <FeatureCard key={feature.id}>
              <IconBox>{iconMap[feature.icon]}</IconBox>
              <h3 className="text-lg font-bold text-gray-900 mb-3 mt-4">{feature.title}</h3>
